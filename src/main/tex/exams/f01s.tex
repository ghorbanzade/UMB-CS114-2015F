...
\item Execution Script \hfill Expected Output\\
\texttt{java HelloWorld Beacons} \hfill \texttt{Hello Beacons!}
\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/HelloWorld.java}

\item Execution Script \hfill Expected Output\\
\texttt{java Temperature 86} \hfill \texttt{30.00}
\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/Temperature.java}

\newpage

\item Execution Script \hfill Expected Output\\
\texttt{java Array 3} \hfill \texttt{6}
\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/Array.java}

\item Execution Script \hfill Expected Output\\
\texttt{java Random 5} \hfill integer $x$ where $0 \leq x < 5$
\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/Random.java}

\newpage

\item Execution Script \hfill Expected Output\\
\texttt{java CircleDemo 1} \hfill 3.14
\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/CircleDemo.java}
\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/Circle.java}
...
\lstinputlisting[firstline=12]{\javaDirectory/f01/Math.java}
...
\lstinputlisting[firstline=12]{\javaDirectory/f01/Triangle1.java}
...
\lstinputlisting[firstline=12, language=java]{\javaDirectory/f01/Triangle2.java}
...
\lstinputlisting[firstline=12, language=java]{\javaDirectory/f01/Matrix.java}
...
\lstinputlisting[firstline=12]{\javaDirectory/f01/Grader.java}
...
\begin{enumerate}
	...
	\lstinputlisting[firstline=12,language=java]{\javaDirectory/f01/Student.java}
